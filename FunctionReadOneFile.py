def readOneFileFunction (rootFileName="/Volumes/BROCKU/Elena/OptTrack11110.root"):
    comboName = int(rootFileName[-10:-5])

    import os
    import math
    import copy
    import ROOT
    from ROOT import gStyle, TH1D, TFile, TTree, TCanvas, gROOT
    import math
...
#rootFileName = "/Volumes/BROCKU/Elena/OptTrack11110.root"
    ...
    hMatchedR = ROOT.gROOT.FindObject("hMatchedR")
    ...
    hMatchedW = ROOT.gROOT.FindObject("hMatchedW")
...
#print "Number of wrong matches ", WrongMatchedTracks
    ...
    return  comboName,matchingEfficiency , rigthMatchingEfficiency, percentageOfCorrectlyMatchedTracks , percentageOfWronglyMatchedTracks,percentageRightVtx , percentageRightEnd  ,percentageRightDeltaL, percentageLongDeltaL, percentageShortDeltaL,funnyBusinness
